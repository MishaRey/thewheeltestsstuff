(self.webpackChunkjackbox_tv = self.webpackChunkjackbox_tv || []).push([
    [4948], {
        14948: (e, t, s) => {
            ...
            const U = {
                en: {
                    STATUS_GAME_FULL: "Игра завершена",
                    ...
                    SUBMIT_JOIN_AUDIENCE: "ПРИСОЕДИНИТЬСЯ К АУДИТОРИИ",
                    SUBMIT_RECONNECT: "ПЕРЕПОДКЛЮЧИТЬСЯ",
                    SUBMIT_TWITCH_LOGIN: "ВОЙТИ В СИСТЕМУ TWITCH",
                    TOS_WARNING: "Нажимая {submit}, вы соглашаетесь с нашими [tos]Условиями предоставления услуг[/tos]",
                    LANGUAGE_NAME: "English",
                    SUPPORTED_LANGUAGES: ["English", "Français", "Italiano", "Deutsche", "Español"],
                    SUPPORTED_LOCALES: ["en", "fr", "it", "de", "es"],
                    STRING_LOBBY_CENSOR_CONFIRM: "Это удалит имя, аватар, записи и рисунки этого игрока. Вы уверены?",
                    ...
                    STRING_THANK_YOU: "спасибо за ваш рисунок",
                    STRING_DRAWING_OVER: "время рисования закончилось!",
                    STRING_CENSOR_LIE_CONFIRM: "Это приведет к удалению записи этого игрока и всех будущих записей и будущих розыгрышей. ты уверен?",
                    STRING_YES: "Да",
                    STRING_NO: "Нет",
                    STRING_THANK_AUDIENCE: "Спасибо за ваш вклад, член аудитории!",
                    STRING_AUDIENCE_WELCOME_0: "Добро пожаловать в аудиторию<br>это весело!",
                    STRING_AUDIENCE_WELCOME_1: "добро пожаловать в аудиторию<br>вы сможете принять участие буквально через мгновение",
                    STRING_AUDIENCE_WELCOME_2: "добро пожаловать в аудиторию<br> веселье начнется в любую секунду",
                    STRING_AUDIENCE_WELCOME_3: "добро пожаловать в аудиторию<br>мы вас ждали",
                    STRING_AUDIENCE_WELCOME_4: "добро пожаловать в аудиторию<br>не так весело, как владеть игрой, но веселее, чем сидеть в одиночестве и ничего не делать",
                    STRING_AUDIENCE_WELCOME_5: "добро пожаловать в аудиторию<br>чем больше, тем веселее",
                    STRING_AUDIENCE_WELCOME_6: "добро пожаловать в аудиторию<br>один из нас, один из нас",
                    STRING_AUDIENCE_WELCOME_7: "добро пожаловать в аудиторию<br>пожалуйста, не разворачивайте леденцы во время шоу",
                    STRING_AUDIENCE_WELCOME_8: "добро пожаловать в аудиторию<br>пришло наше время здесь",
                    STRING_AUDIENCE_WELCOME_9: "добро пожаловать в аудиторию<br>вам нравится смотреть, а?",
                    STRING_AUDIENCE_WELCOME_10: "добро пожаловать в аудиторию<br>это один из тех медленных моментов для аудитории, но он подхватит",
                    STRING_AUDIENCE_WELCOME_11: "добро пожаловать в аудиторию<br>пожалуйста, не организуйте и совершите переворот",
                    STRING_AUDIENCE_WELCOME_12: "добро пожаловать в аудиторию<br>чувствуйте себя как дома",
                    STRING_AUDIENCE_WELCOME_13: "добро пожаловать в аудиторию<br>мы надеемся, вам нравится судить людей",
                    STRING_AUDIENCE_WELCOME_14: "добро пожаловать в аудиторию<br>сделайте глубокий вдох, действие скоро начнется",
                    STRING_AUDIENCE_WELCOME_15: "добро пожаловать в аудиторию<br>наслаждайтесь",
                    STRING_AUDIENCE_WELCOME_16: "добро пожаловать в аудиторию<br>всех в аудитории, вы наши любимые",
                    STRING_AUDIENCE_WELCOME_17: "добро пожаловать в аудиторию<br>мечты сбываются!",
                    STRING_AUDIENCE_WELCOME_18: "Добро пожаловать в аудиторию<br>второй по увлекательности способ играть в эту игру!",
                    STRING_AUDIENCE_WELCOME_19: "добро пожаловать в аудиторию<br>мы написали это дополнительное предложение здесь только для вас",
                    STRING_AUDIENCE_WELCOME_20: "добро пожаловать в аудиторию<br>пожалуйста, найдите свое место",
                    STRING_AUDIENCE_WELCOME_21: "добро пожаловать в аудиторию<br>тааак... что у тебя нового?",
                    STRING_AUTHOR_MESSAGE_0: "Ты нарисовал это.<br>Найдите минутку, чтобы поразмыслить.",
                    STRING_AUTHOR_MESSAGE_1: "Вы нарисовали это.<br>Может быть, обратиться к врачу?",
                    STRING_AUTHOR_MESSAGE_2: "Ты нарисовал это.<br>Вот кем ты стал.",
                    STRING_AUTHOR_MESSAGE_3: "Ты нарисовал это.<br>Это ваш дизайн.",
                    STRING_AUTHOR_MESSAGE_4: "Вы нарисовали это.<br> Нам некуда идти, кроме как вверх!",
                    STRING_AUTHOR_MESSAGE_5: "Ты нарисовал это.<br>Расслабься.",
                    STRING_AUTHOR_MESSAGE_6: "Ты нарисовал это.<br>Наслаждайтесь этим моментом.",
                    STRING_AUTHOR_MESSAGE_7: "Ты нарисовал это.<br> Уже слишком поздно что-то менять.",
                    STRING_AUTHOR_MESSAGE_8: "Ты нарисовал это.<br>Нет никакого способа обвинить кого-то другого.",
                    STRING_AUTHOR_MESSAGE_9: "Ты нарисовал это.<br>И твоя жизнь навсегда изменилась.",
                    STRING_AUTHOR_MESSAGE_10: "Ты нарисовал это.<br>Ура?",
                    STRING_AUTHOR_MESSAGE_11: "Ты нарисовал это.<br>Без комментариев.",
                    STRING_AUTHOR_MESSAGE_12: "Вы нарисовали это.<br>Могло быть и хуже.",
                    STRING_AUTHOR_MESSAGE_13: "Ты нарисовал это.<br>Ты виноват.",
                    STRING_AUTHOR_MESSAGE_14: "Ты нарисовал это.<br>Так что... да...",
                    STRING_AUTHOR_MESSAGE_15: "Ты нарисовал это.<br>Не волнуйся, это скоро закончится.",
                    STRING_AUTHOR_MESSAGE_16: "Ты нарисовал это.<br>Радуйтесь этому так хорошо, как только можете.",
                    STRING_AUTHOR_MESSAGE_17: "Вы нарисовали это.<br>Это искусство.",
                    STRING_AUTHOR_MESSAGE_18: "Ты нарисовал это.<br>Спасибо?",
                    STRING_AUTHOR_MESSAGE_19: "Ты нарисовал это.<br>Дай пять!",
                    STRING_AUTHOR_MESSAGE_20: "Ты нарисовал это.<br>Может быть, немного вздремнешь.",
                    STRING_AUTHOR_MESSAGE_21: "Ты нарисовал это.<br>Будь спокоен.",
                    STRING_AUTHOR_MESSAGE_22: "Ты нарисовал это.<br>Это тоже пройдет.",
                    STRING_AUTHOR_MESSAGE_23: "Ты нарисовал это.<br>Разберись с этим.",
                    STRING_AUTHOR_MESSAGE_24: "Ты нарисовал это.<br>Столкнись с последствиями.",
                    STRING_AUTHOR_MESSAGE_25: "Ты нарисовал это.<br> Дело сделано.",
                    STRING_AUTHOR_MESSAGE_26: "Ты нарисовал это?<br>Все в порядке. Все будет хорошо.",
                    STRING_AUTHOR_MESSAGE_27: "Ты нарисовал это.<br>Но ты все равно заслуживаешь любви, наверное.",
                    STRING_AUTHOR_MESSAGE_28: "Ты нарисовал это.<br>Спасибо.",
                    STRING_AUTHOR_MESSAGE_29: "Ты нарисовал это.<br>Творение само по себе дар.",
                    STRING_AUTHOR_MESSAGE_30: "Ты нарисовал это.<br>Ха-ха-ха-ха-ха.",
                    STRING_AUTHOR_MESSAGE_31: "Ты нарисовал это.<br> И я люблю тебя за это.",
                    STRING_AUTHOR_MESSAGE_32: "Ты нарисовал это.<br>Странно.",
                    STRING_AUTHOR_MESSAGE_33: "Ты нарисовал это.<br>Надеюсь, у вас это получится.",
                    STRING_AUTHOR_MESSAGE_34: "Вы нарисовали это.<br>Задумывались ли вы когда-нибудь о том, что вы, возможно, единственный человек во вселенной? А все остальное... все, каждая вещь - это только в твоем воображении? А ты?",
                    STRING_AUTHOR_MESSAGE_35: "Ты нарисовал это.<br> И всем было весело.",
                    STRING_AUTHOR_MESSAGE_36: "Ты нарисовал это.<br>Это не будет полностью оценено, пока ты не умрешь.",
                    STRING_AUTHOR_MESSAGE_37: "Ты нарисовал это.<br>Но ты, вероятно, уже знаешь это.",
                    STRING_AUTHOR_MESSAGE_38: "Ты нарисовал это.<br>Ты.",
                    STRING_AUTHOR_MESSAGE_39: "Ты нарисовал это.<br>Только история может судить вас.",
                    STRING_AUTHOR_MESSAGE_40: "Вы нарисовали это.<br>Наслаждайтесь этим.",
                    STRING_AUTHOR_MESSAGE_41: "Вы нарисовали это.<br> Это хорошо.",
                    STRING_SUBMIT_ALERT: "вы подошли слишком близко к реальному названию или ввели что-то, что уже сделал кто-то другой!",
                    ERROR_DRAWING_EMPTY: "Вы должны что-то нарисовать!",
                    STRING_SKIP_BUTTON: "пропустить (это оскорбительно)",
                    STRING_SKIP_BUTTON_CONFIRM: "вы уверены?",
                    STRING_TEXT_SUBMIT_ALERT: "вы ничего не можете ввести!",
                    STRING_ERROR_INVALID_ROOM_CODE: "Недопустимый код номера",
                    STRING_ERROR_UNABLE_TO_JOIN: "Не удается подключиться к серверу Jackbox Games. Обычно это вызвано блокировщиками рекламы или расширениями конфиденциальности.", 
                    ...
                    LANGUAGE: "Язык",
                    LOGIN: "Логин",
                    STRING_CAMERA_WARNING: "[b]ВНИМАНИЕ: [/b] Мы не обнаруживаем камеру, но вы все равно можете играть в игру без фотографии. Если это кажется неправильным, попробуйте подключиться с помощью другого браузера.",
                    STRING_STYLE_WARNING: "[b]ВНИМАНИЕ:[/b] Ваш браузер, похоже, немного устарел и будет иметь некоторые проблемы с отображением этой игры.",
                    STRING_NAME: "ИМЯ",
                    STRING_NAME_PLACEHOLDER: "ВВЕДИТЕ СВОЕ ИМЯ",
                    ...
                    ERROR_UNSUPPORTED_WEBSOCKETS: "Веб-сокеты не поддерживаются в вашем браузере.",
                    ERROR_ROOM_FULL: "Игра заполнена",
                    ERROR_AUDIENCE_FULL: "Аудитория заполнена",
                    ERROR_INVALID_ROOMCODE: "Неверный код комнаты",
                    ERROR_UNABLE_TO_CONNECT: "Не удается подключиться к серверу Jackbox Games. Обычно это вызвано блокировщиками рекламы или расширениями конфиденциальности.",
                    ERROR_GAME_LOCKED: "Игра продолжается. Пожалуйста, дождитесь начала новой игры.",
                    AD_AVAILABLE_NOW: "Доступно сейчас!",
                    AD_ON_SALE: "В продаже!",
                    STRING_PASSWORD_REQUIRED_TITLE: "Требуется пароль",
                    STRING_PASSWORD_REQUIRED_BODY: "Пожалуйста, введите пароль или присоединяйтесь как участник аудитории",
                    STRING_PASSWORD_JOIN_AS_PLAYER: "Присоединяйтесь как игрок",
                    STRING_PASSWORD_JOIN_AS_AUDIENCE: "Присоединяйтесь к аудитории",
                    STRING_ERROR_SERVER_ERROR: "Невозможно присоединиться к комнате из-за ошибки сервера",
                    STRING_ERROR_TWITCH_COOKIES: "Для входа в систему требуются файлы cookie в с Twitch",
                    STRING_ERROR_GAME_UNSUPPORTED: "Эта игра не поддерживается в этом браузере.",
                    STRING_ERROR_REQUIRES_TWITCH_LOGIN: "Игра требует входа в Twitch",
                    STRING_ERROR_ROOM_IS_LOCKED: "Игра заблокирована",
