        ...
        14948: (e, t, s) => {
            ...
            const U = {
                en: {
                    ...
                    SUBMIT_JOIN_AUDIENCE: "ПРИСОЕДИНИТЬСЯ К ЗРИТЕЛЯМ",
                    ...
                    STRING_YES: "Да",
                    STRING_NO: "Нет",
                    STRING_THANK_AUDIENCE: "Спасибо за ваш вклад, зритель!",
                    STRING_AUDIENCE_WELCOME_0: "Добро пожаловать к зрителям<br>это весело!",
                    STRING_AUDIENCE_WELCOME_1: "добро пожаловать к зрителям<br>вы сможете принять участие буквально через мгновение",
                    STRING_AUDIENCE_WELCOME_2: "добро пожаловать к зрителям<br> веселье начнется в любую секунду",
                    STRING_AUDIENCE_WELCOME_3: "добро пожаловать к зрителям<br>мы вас ждали",
                    STRING_AUDIENCE_WELCOME_4: "добро пожаловать к зрителям<br>не так весело, как владеть игрой, но веселее, чем сидеть в одиночестве и ничего не делать",
                    STRING_AUDIENCE_WELCOME_5: "добро пожаловать к зрителям<br>чем больше, тем веселее",
                    STRING_AUDIENCE_WELCOME_6: "добро пожаловать к зрителям<br>один из нас, один из нас",
                    STRING_AUDIENCE_WELCOME_7: "добро пожаловать к зрителям<br>пожалуйста, не разворачивайте леденцы во время шоу",
                    STRING_AUDIENCE_WELCOME_8: "добро пожаловать к зрителям<br>пришло наше время здесь",
                    STRING_AUDIENCE_WELCOME_9: "добро пожаловать к зрителям<br>вам нравится смотреть, а?",
                    STRING_AUDIENCE_WELCOME_10: "добро пожаловать к зрителям<br>это один из тех медленных моментов для зрителей, но это пройдёт",
                    STRING_AUDIENCE_WELCOME_11: "добро пожаловать к зрителям<br>пожалуйста, не организуйте и совершите переворот",
                    STRING_AUDIENCE_WELCOME_12: "добро пожаловать к зрителям<br>чувствуйте себя как дома",
                    STRING_AUDIENCE_WELCOME_13: "добро пожаловать к зрителям<br>мы надеемся, вам нравится судить людей",
                    STRING_AUDIENCE_WELCOME_14: "добро пожаловать к зрителям<br>сделайте глубокий вдох, действие скоро начнется",
                    STRING_AUDIENCE_WELCOME_15: "добро пожаловать к зрителям<br>наслаждайтесь",
                    STRING_AUDIENCE_WELCOME_16: "добро пожаловать к зрителям<br>всех к зрителям, вы наши любимые",
                    STRING_AUDIENCE_WELCOME_17: "добро пожаловать к зрителям<br>мечты сбываются!",
                    STRING_AUDIENCE_WELCOME_18: "Добро пожаловать к зрителям<br>второй по увлекательности способ играть в эту игру!",
                    STRING_AUDIENCE_WELCOME_19: "добро пожаловать к зрителям<br>мы написали это дополнительное предложение здесь только для вас",
                    STRING_AUDIENCE_WELCOME_20: "добро пожаловать к зрителям<br>пожалуйста, найдите свое место",
                    STRING_AUDIENCE_WELCOME_21: "добро пожаловать к зрителям<br>тааак... что у тебя нового?",
                    ...
                    ERROR_AUDIENCE_FULL: "Зрители заполнены",
                    ...
                    STRING_PASSWORD_REQUIRED_BODY: "Пожалуйста, введите пароль или присоединяйтесь как участник зрителей",
                    STRING_PASSWORD_JOIN_AS_PLAYER: "Присоединяйтесь как игрок",
                    STRING_PASSWORD_JOIN_AS_AUDIENCE: "Присоединяйтесь к зрителям",
