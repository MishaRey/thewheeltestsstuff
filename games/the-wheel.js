        ...
        21057: (t, s, e) => {
            ...
            const y = {
                    ...
                    AUDIENCE: {
                        ...
                        THANKS: ["Вами чебуреками, гордится весь Китай! Социальный статус ваш повысился, вам даётся тарелка риса и кошко-девочка.", "С каждым твоим нажатием, умирает чья-то лошадь!", "Вы кто такие? Я вас не звал.", "Чел, если бы ты знал что твой голос ничего не значит, ты бы расплакался.", "Вы знали что вы только что нажали на “Отправить свои деньги Колесу”?", "Дорогой дневник, мне не перенести ту боль..."]
                    },
                    GUESSING: {
                        BANNER: "ВЫ ДУМАЛИ?",
                    ...
                    WAITING: {
                        ...
                        MESSAGES: ["Запомните твари, а то забудете.", "Здесь пустовато. Я опять в твоём мозгу?", "Я выпил таблетку от шизы, но почему ты не пропал?", "Ожидания ожидания, ты ожидаешь ожидание!", "Вы в очереди 512-ый, сейчас только первого обслуживаем!", "Эй, привет красотка! А ой, прости, перепутал тебя со страшной подругой.", "(https://youtu.be/dQw4w9WgXcQ)", "Руки на стол, каменщик. Ты думаешь я ничего не вижу?", "!", ".", "?", "Здесь могла быть ваша реклама.", "Хватит пялиться, я стесняюсь.", "После этой игры, все проигравшие пересказывают мне Войну и мир.", "Колесо Ненормального Троллинга купил тебя", "Здесь была твоя мамка", "Привет, пупсик", "Листаешь комменты, сладкий?", "Чё зыришь? Глаза пузыришь", "Продам гараж, звоните: 88005553535", "Нажав кнопку \"Пукнуть\", вы приняли соглашение, что мы можем через ваш сайт криптомайнить"]
                    },
                    ARIA: {
                        ANSWER: "сектор ответа.",
                        AUDIENCE: "сектор чебуреков.",
                        BAD: "сектор тролля.",
