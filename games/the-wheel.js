    ...
    ["games/the-wheel"], {
        ...
        21057: (t, s, e) => {
            ...
            const y = {
                    ...
                    GUESSING: {
                        BANNER: "ВЫ ДУМАЛИ, ЧТО Я ВАС НЕ ПЕРЕИГРАЮ?",
                        INCORRECT: "НЕПРАВИЛЬНО, ПОПРОБУЙТЕ ПЕРЕИГРАТЬ МЕНЯ ЕЩЁ РАЗ",
                    ...
                    RAPID: {
                        BANNER: "Соль переборщил [small]ИЛИ[/small] борщ пересолил",
                        CORRECT: "ПРАВИЛЬНО",
                        FROZEN: "ЗАБАНЕН, ЧЕКАЙ"
                    },
                    SPIN: {
                        ANSWER_BANNER: "ВЫ ЗАБАНЕНЫ!",
                        MAIN_BANNER: "ДА КРУТИ ТЫ [small]ЭТО[/small] КОЛЕСО УЖЕ!",
